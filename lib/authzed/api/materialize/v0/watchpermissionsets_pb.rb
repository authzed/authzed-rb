  ...
  module Api
    module Materialize
      module V0
        ...
        DownloadPermissionSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("authzed.api.materialize.v0.DownloadPermissionSetsRequest").msgclass
        File = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("authzed.api.materialize.v0.File").msgclass
        DownloadPermissionSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("authzed.api.materialize.v0.DownloadPermissionSetsResponse").msgclass
      end
    end
  end
end
