...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("authzed/api/v1/error_reason.proto", :syntax => :proto3) do
    add_enum "authzed.api.v1.ErrorReason" do
      ...
      value :ERROR_REASON_CAVEAT_EVALUATION_ERROR, 14
      value :ERROR_REASON_INVALID_CURSOR, 15
      value :ERROR_REASON_TOO_MANY_RELATIONSHIPS_FOR_TRANSACTIONAL_DELETE, 16
      value :ERROR_REASON_MAX_RELATIONSHIP_CONTEXT_SIZE, 17
      value :ERROR_REASON_ATTEMPT_TO_RECREATE_RELATIONSHIP, 18
      value :ERROR_REASON_MAXIMUM_DEPTH_EXCEEDED, 19
    end
  end
end
